...
class Osoba {
  ...
  renderCard(className = '') {
    ...
    <img class="person__img" src="${this.imageURL}" />
    <div class="person__data">
      <h3 class="person__firstname">${this.firstName}</h3>
      <h4 class="person__lastname">${this.lastName}</h4>
      <p class="person__bio"><span>Bio:</span>„${this.bio}”
      </p>
      <p class="person__row"><span>👉</span>${this.facts[0]}</p>
      <p class="person__row"><span>👉</span>${this.facts[1]}</p>
      <p class="person__row"><span>👉</span>${this.facts[2]}</p>
    </div>
  </article>`;
  ...
  renderResult(resultPerson, className = 'guess') {
    const html = `
      <article id="${resultPerson.id}" class="person ${className}">
        <img class="person__img" src="${resultPerson.imageURL}" />
        <div class="person__data">
          <h3 class="person__firstname">${resultPerson.firstName}</h3>
          <h4 class="person__lastname">${resultPerson.lastName}</h4>
          <p class="person__row"><span>👉</span>${resultPerson.facts[0]}</p>
          <p class="person__row"><span>👉</span>${resultPerson.facts[1]}</p>
          <p class="person__row"><span>👉</span>${resultPerson.facts[2]}</p>
        </div>
      </article>`;
